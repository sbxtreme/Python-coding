...
input_file="/Users/capgemini/Downloads/Blains.PROD.Additions.csv"
...
# Global counter to track the number of records written in csv
...
def get_data(data,ext_id):
	try:
		''' This function recieves the json from response , extract the values and write it in Csv file '''
		...
		df.to_csv(log_dir+'/'+'output1.csv', encoding='utf-8', index=False,header=False,mode='a')
